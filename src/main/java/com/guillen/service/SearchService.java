...
import com.guillen.api.CrcindCtrl;
...
public class SearchService {
	...
	@Autowired
	private CrcindCtrl crcindCtrl;

	@GetMapping
	public SearchResponse prueba(@RequestParam(required = false) String term,
		...
		try {
			...
			case "show":
				...
				break;
			case "person":
				crcindCtrl.search(term, resultList);
				break;
			default:
				appleCtrl.search(term, kind, resultList);
				tvmazeCtrl.search(term, resultList);
